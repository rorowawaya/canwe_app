    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_register_submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(!TextUtils.isEmpty(String.valueOf(txt_register_username.getText().toString().trim())) && !TextUtils.isEmpty(String.valueOf(txt_register_username.getText().toString().trim())) && !TextUtils.isEmpty(String.valueOf(txt_register_email.getText().toString().trim()))) {
                    Toast.makeText(Registerr.this, dbref.toString(), Toast.LENGTH_SHORT).show();
                    //insert into table
                    dbref.child(txt_register_userid.getText().toString().trim()).setValue(m);

                    Intent intent = new Intent(Registerr.this, Menu.class);
                    startActivity(intent);
                }
            }
        });
...
/*
        ...
        btn_register_submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent=new Intent(Register.this,Model_User .class);
                startActivity(intent);
            }
        });*/
